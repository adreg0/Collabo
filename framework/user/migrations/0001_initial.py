    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.PositiveSmallIntegerField(blank=True, choices=[(0, 'Not Known'), (1, 'Male'), (2, 'Female'), (9, 'Not Applicable')], null=True)),
                ('city', models.CharField(blank=True, default='', max_length=127)),
                ('state', models.CharField(blank=True, default='', max_length=127)),
